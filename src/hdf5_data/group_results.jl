...
# for m in dataset
# 	c = zeros(Float32, 20, 20)
# 	c[1, 1] = GeDetMeasurements.read_core_calibration_factor_from_HDF5(m)
# 	c[2:end, 2:end] = GeDetMeasurements.read_crosstalk_and_calibration_matrix(m)
# 	GeDetMeasurements.write_calibration_matrix(m, c)
# 	c = GeDetMeasurements.determine_calibration_matrix_with_daq_energies(m)
# 	GeDetMeasurements.write_daq_calibration_matrix(m, c)
# end